...
function jigs_up
  (desc: string) {
    ...
    let random_list: list(
        /*[*/ [rest,
          room] /*]*/) = GLOBALS.random_list;
    let lamp: false || room = find_obj(
        "LAMP");
...
function walk
  () {
    ...
    let nrm: false || /*<*/ [primtype(
            vector),
          /*[*/ [rest,
            atom,
            room || nexit || cexit] /*]*/] /*>*/ = null;
    let where: atom = chtype(
        GLOBALS.prsvec[2],
        atom);
  ...
  (take_Q?: atom || false) {
    ...
    let aobjs: list(
        /*[*/ [rest,
          object] /*]*/) = aobjs(
        win);
    let load_max: fix = GLOBALS.load_max;
    prog(
    /*(*/ [] /*)*/,
    cond(
      /*(*/ [trnn(
