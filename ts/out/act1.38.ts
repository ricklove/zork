...
function echo_room
  () {
    ...
    let reader_string = GLOBALS.reader_string;
    let b = GLOBALS.inbuf;
    let l = null;
    let rm = find_room(
        "ECHO");
