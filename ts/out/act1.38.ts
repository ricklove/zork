    ...
    /*(*/ [prsact === GLOBALS.look_X_words,
      ...
      rug_Q = orand(
          find_obj(
            "RUG")),
      cond(
        /*(*/ [rug_Q && GLOBALS.trap_door_X_flag,
          tell(
      ...
      t] /*)*/,
    /*(*/ [tc = find_obj(
            "TCASE") && prsact === GLOBALS.take_X_words || prsact === GLOBALS.put_X_words && prsvec[3] === tc,
      put(
        GLOBALS.winner,
        GLOBALS.ascore,
        _(
...
function clearing
  () {
    ...
    let prsact: verb = GLOBALS.prsvec[1];
    let rm: room = GLOBALS.here;
    let grate: object = find_obj(
        "GRAT1");
    let leaves: object = find_obj(
        "LEAVE");
    let rv: number = rvars(
        rm);
    cond(
      ...
      cond(
        ...
        /*(*/ [!0_Q(
          ...
          tell(
            ...
            1)] /*)*/)] /*)*/,
    /*(*/ [0_Q(
          rv) && prsact === GLOBALS.burn_X_words && !0_Q(
                orand(
                  leaves)) || prsact === GLOBALS.take_X_words || prsact === GLOBALS.move_X_words && GLOBALS.prsvec[2] === leaves,
      tell(
...
function cellar
  () {
    ...
    /*(*/ [vname(
            prsact) === walk_in_X_words && GLOBALS.trap_door_X_flag && !otouch_Q(
            door),
...
function troll
  () {
    ...
    let t: object = find_obj(
        "TROLL");
    let a: object = find_obj(
        "AXE");
    cond(
    /*(*/ [pa === GLOBALS.fight_X_words,
      cond(
        /*(*/ [ocan(
              a) === t,
          null] /*)*/,
...
function mirror_room
  () {
    ...
    let prsact: verb = GLOBALS.prsvec[1];
    cond(
    /*(*/ [prsact === GLOBALS.look_X_words && lit_Q(
          GLOBALS.here),
      tell(
  ...
  () {
    ...
    let l1: list(
        /*[*/ [rest,
          object] /*]*/) = null;
    cond(
    /*(*/ [!GLOBALS.mirror_mung_X_flag && vname(
            prsact) === rub_X_words,
      rm1 = GLOBALS.here,
      rm2 = cond(
          /*(*/ [rm1 === find_room(
...
function carousel_room
  () {
    ...
    let pv: vector = GLOBALS.prsvec;
    cond(
    /*(*/ [pv[1] === GLOBALS.walk_in_X_words && GLOBALS.carousel_zoom_X_flag,
      jigs_up(
        GLOBALS.spindizzy)] /*)*/,
...
function treas
  () {
    ...
    cond(
    /*(*/ [GLOBALS.prsvec[1] === GLOBALS.treas_X_words && GLOBALS.here === find_room(
            "TEMP1"),
      goto(
        find_room(
          "TREAS")),
    ...
    /*(*/ [GLOBALS.prsvec[1] === GLOBALS.templ_X_words && GLOBALS.here === find_room(
            "TREAS"),
      goto(
        find_room(
          "TEMP1")),
  ...
  () {
    ...
    let prsvec: vector(
        /*[*/ [3,
          any] /*]*/) = GLOBALS.prsvec;
    cond(
    /*(*/ [prsvec[1] === GLOBALS.put_X_words && prsvec[3] === find_obj(
            "TUBE"),
      tell(
...
function fill
  () {
    ...
    /*(*/ [rtrnn(
          GLOBALS.here,
          GLOBALS.rfillbit) || rem = ocan(
                w) === avehicle(
                GLOBALS.winner) || oroom(
                w) === GLOBALS.here,
      put(
        prsvec,
        1,
...
function water_function
  (rem?: atom | false) {
    ...
    cond(
    /*(*/ [prsact === GLOBALS.take_X_words || prsact === GLOBALS.put_X_words,
      cond(
        /*(*/ [av && av === can,
          tell(
        ...
        /*(*/ [ocan(
                w) === b && prsact === GLOBALS.take_X_words && !can,
          put(
            prsvec,
            2,
            b),
...
function rope_function
  () {
    ...
    let prsact: verb = GLOBALS.prsvec[1];
    let droom: room = find_room(
        "DOME");
    let rope: object = find_obj(
        "ROPE");
    let win: adv = GLOBALS.winner;
    cond(
    /*(*/ [GLOBALS.here !== droom,
      ...
      cond(
        ...
        /*(*/ [vname(
              prsact) === untie_X_words,
          tell(
            "It is not tied to anything.")] /*)*/)] /*)*/,
    /*(*/ [vname(
            prsact) === tie_X_words && GLOBALS.prsvec[3] === find_obj(
            "RAILI"),
      cond(
        /*(*/ [GLOBALS.dome_flag_X_flag,
          tell(
    ...
    /*(*/ [prsact === GLOBALS.take_X_words && GLOBALS.dome_flag_X_flag && tell(
...
function cyclops
  () {
    ...
    let rm: room = GLOBALS.here;
    let food: object = find_obj(
        "FOOD");
    let drink: object = find_obj(
        "WATER");
    let count: number = rvars(
        rm);
    let garlic: object = find_obj(
        "GARLI");
    let cyc: object = null;
    cond(
    /*(*/ [GLOBALS.cyclops_flag_X_flag,
      cond(
        /*(*/ [prsact === GLOBALS.awake_X_words || prsact === GLOBALS.mung_X_words || prsact === GLOBALS.burn_X_words || prsact === GLOBALS.fight_X_words,
          tell(
      ...
      cond(
        ...
        /*(*/ [tell(
          ...
          put(
            ...
            aos_sos(
              count))] /*)*/)] /*)*/,
    /*(*/ [prsact === GLOBALS.first_Q_X_words || prsact === GLOBALS.fight_X_words,
      null] /*)*/,
    /*(*/ [put(
          rm,
          GLOBALS.rvars,
          aos_sos(
            count)) && null] /*)*/,
    /*(*/ [prsact === GLOBALS.throw_X_words || vname(
            prsact) === mung_X_words,
      cond(
        /*(*/ [prob(
            50),
...
function cyclops_room
  () {
    ...
    /*(*/ [pv[1] === GLOBALS.look_X_words,
      ...
      cond(
        /*(*/ [GLOBALS.cyclops_flag_X_flag && !GLOBALS.magic_flag_X_flag,
          tell(
              ...
              /*(*/ [eparse(
                    lex(
                      ...
                      rest(
                        ...
                        l),
                      t),
                    t) && verb = prsvec[1] === walk && prsvec[2] && memq(
                    chtype(
                      prsvec[2],
                      atom),
                    rexits(
...
function eat
  () {
    ...
    let prsvec: vector(
        /*[*/ [3,
          any] /*]*/) = GLOBALS.prsvec;
    let eat_Q: atom | false = null;
    let drink_Q: atom | false = null;
    ...
    /*(*/ [eat_Q = edible_Q(
          ...
          aobjs),
      cond(
        /*(*/ [prsvec[1] === GLOBALS.drink_X_words,
          tell(
  ...
  prog(
    ...
    cond(
      ...
      /*(*/ [memq(
            hobj,
            robjs(
              rm)) && // Leave if victim left && snarf_object(
            hobj,
            still) && remove_object(
            hobj) && here_Q = null] /*)*/,
      /*(*/ [oroom(
              still) === rm && snarf_object(
            hobj,
            still) && null] /*)*/,
      /*(*/ [seen_Q,
        ...
        cond(
          /*(*/ [rdesc2(
                  rm) === GLOBALS.mazedesc && rdesc2(
                  wroom) === GLOBALS.mazedesc,
            mapf(
              null,
              function
                (x: object) {
...
function robber_function
  () {
    ...
    let t: verb = hobj(
        dem);
    let chali: object = find_obj(
        "CHALI");
    cond(
    /*(*/ [prsact === GLOBALS.fight_X_words,
      cond(
        /*(*/ [ocan(
              st = find_obj(
                  "STILL")) === t,
...
tro(
      ...
      put(
        ...
        GLOBALS.haction,
        null)] /*)*/,
    /*(*/ [prsact === GLOBALS.first_Q_X_words,
      prob(
        20)] /*)*/,
    ...
    /*(*/ [type_Q(
          prsobj,
          object) && pv[2] === GLOBALS.knife_X_objects && vname(
            prsact) === throw_X_words && !trnn(
            t,
            GLOBALS.fightbit),
      cond(
        /*(*/ [prob(
        ...
        /*(*/ [t,
          ...
          tro(
            t,
            GLOBALS.fightbit)] /*)*/)] /*)*/,
    /*(*/ [prsact === GLOBALS.throw_X_words || prsact === GLOBALS.give_X_words && type_Q(
          prsobj,
          object) && prsobj !== hobj(
            dem),
      cond(
...
function lantern
  () {
    ...
    let verb: verb = pv[1];
    let here: room = GLOBALS.here;
    let rlamp: object = find_obj(
        "LAMP");
    let foo: vector(
        any,
        cevent) = null;
    cond(
    /*(*/ [verb === GLOBALS.throw_X_words,
      tell(
...
function sword
  () {
    ...
    let pa: verb = GLOBALS.prsvec[1];
    cond(
    /*(*/ [pa === GLOBALS.take_X_words && GLOBALS.winner === GLOBALS.player,
      put(
        GLOBALS.sword_demon,
        GLOBALS.haction,
        cond(
...
function match_function
  () {
    ...
    let match: object = find_obj(
        "MATCH");
    let mc: number = orand(
        match);
    cond(
    /*(*/ [prsa === GLOBALS.light_X_words && prso === match,
      cond(
        /*(*/ [put(
              match,
              GLOBALS.orand,
    ...
    /*(*/ [prsa === GLOBALS.turn_off_X_words && 1_Q(
          olight_Q(
            match)),
      tell(
        "The match is out."),
